...
movieParam.imageDir = '???/u-track/example/images/'; %directory where images are
...
saveResults.dir = '???/u-track/example/analysisCommandLine/'; %directory where to save input and output
